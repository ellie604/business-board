...
const BuyerDashboard: React.FC = () => {
  ...
  const menuItems = [
    { label: 'Home', path: '/dashboard/buyer' },
    { label: 'Email Agent', path: '/dashboard/buyer/email-agent' },
    { label: 'Non Disclosure', path: '/dashboard/buyer/nda' },
    { label: 'Financial Statement', path: '/dashboard/buyer/financial' },
    { label: 'CBR/CIM', path: '/dashboard/buyer/cbr' },
    { label: 'Upload Docs', path: '/dashboard/buyer/upload' },
    { label: 'Purchase Contract', path: '/dashboard/buyer/contract' },
    { label: 'Due Diligence', path: '/dashboard/buyer/due-diligence' },
    { label: 'Pre Close Checklist', path: '/dashboard/buyer/pre-close' },
    { label: 'Closing Docs', path: '/dashboard/buyer/closing' },
    { label: 'After The Sale', path: '/dashboard/buyer/after-sale' }
  ];
