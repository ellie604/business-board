...
const SellerDashboard: React.FC = () => {
  ...
  const menuItems = [
    { label: 'Home', path: '/dashboard/seller' },
    { label: 'Email Agent', path: '/dashboard/seller/email-agent' },
    { label: 'Listing Agreement', path: '/dashboard/seller/listing-agreement' },
    { label: 'Questionnaire', path: '/dashboard/seller/questionnaire' },
    { label: 'Upload Documents', path: '/dashboard/seller/upload' },
    { label: 'Buyer Activity', path: '/dashboard/seller/buyer-activity' },
    { label: 'Purchase Agreement', path: '/dashboard/seller/agreement' },
    { label: 'Due Diligence', path: '/dashboard/seller/due-diligence' },
    { label: 'Pre-Close Checklist', path: '/dashboard/seller/pre-close' },
    { label: 'Closing Documents', path: '/dashboard/seller/closing' },
    { label: 'After The Sale', path: '/dashboard/seller/after-sale' }
  ];
