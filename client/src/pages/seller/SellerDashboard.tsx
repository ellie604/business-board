        ...
        <div className="flex-1 p-4 lg:p-8">
          ...
          {location.pathname === '/seller' && (
            <div className="max-w-6xl mx-auto">
              ...
              <div className="mb-6 lg:mb-8 p-4 lg:p-6 bg-blue-50 border border-blue-200 rounded-lg">
                <h2 className="text-lg lg:text-xl font-semibold text-blue-900 mb-3">
                  Step One: Get Started with Your Broker
                </h2>
                <p className="text-blue-800 mb-4 leading-relaxed">
                  Please either message, text or call the broker (Wes Brown) to get started. He will personally help assess the Most Probable Selling Price of your business, and explain our entire process. If you decide to proceed, then we will create a listing agreement as your next step in the selling process.
                </p>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between bg-white p-4 rounded-lg border border-blue-200">
                  <div className="mb-3 sm:mb-0">
                    <h3 className="font-semibold text-gray-900">Contact Wes Brown - Business Broker</h3>
                    <p className="text-sm text-gray-600">Your dedicated acquisition specialist</p>
                  </div>
                  <div className="flex flex-col sm:flex-row gap-2">
                    <a 
                      href="tel:(916)474-0390" 
                      className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors text-center"
                    >
