...
const SellerPreCloseChecklist: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Get current listing
        const listingRes = await sellerService.getCurrentListing();
  ...
  const handleMarkAsFinished = async () => {
    ...
    try {
      // Toggle step 8 completion status
      if (stepCompleted) {
        // If currently completed, mark as incomplete by removing from completed steps
        await sellerService.markStepIncomplete(8);
        alert('Pre-Close Checklist marked as incomplete.');
      } else {
        // If currently incomplete, mark as completed
        await sellerService.markStepCompleted(8);
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`mt-1 ${
                  ...
                  {stepCompleted 
                    ? 'You have successfully completed the Pre-Close Checklist step. Click below to mark as incomplete if needed.'
              ...
              <button
                ...
                className={`px-6 py-3 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center text-lg font-semibold ${
                  stepCompleted
              ...
              >
                {isCompleting ? (
                  <>
                    ...
                    {stepCompleted ? 'Marking Incomplete...' : 'Marking Complete...'}
                  </>
                ) : stepCompleted ? (
                  <>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700 mt-1">
                ...
                real-time collaboration between you, the buyer, and your agent/broker. 
