      ...
      <div className="max-w-6xl mx-auto p-4 lg:p-0">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 lg:p-6 mb-4 lg:mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div>
              <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Step 3: Non Disclosure Agreement</h1>
              <p className="text-gray-600 mt-1 lg:mt-2">Complete the online Non-Disclosure Agreement</p>
            </div>
        ...
        {/* NDA Introduction */}
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 lg:p-6 mb-4 lg:mb-6">
          <h2 className="text-lg lg:text-xl font-semibold text-purple-800 mb-3 lg:mb-4">Non-Disclosure Agreement Information</h2>
          <p className="text-purple-700 mb-3 lg:mb-4 text-sm lg:text-base">
